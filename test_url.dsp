# Microsoft Developer Studio Project File - Name="test_url" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Console Application" 0x0103

CFG=test_url - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "test_url.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "test_url.mak" CFG="test_url - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "test_url - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "test_url - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
!ELSEIF  "$(CFG)" == "test_url - Win32 Debug"
...
# Name "test_url - Win32 Release"
# Name "test_url - Win32 Debug"
# Begin Source File
